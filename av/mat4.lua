...
function mat4.unperspective(fovy, aspect, near, far)
	-- height of view at distance 1:
	local h = tan(fovy * 0.008726646259972)
	local f = 1/h
	local D = far - near
...
function mat4:inverse()
	local res = mat4()
    res[1] = self[6]  * self[11] * self[16] - 
             self[6]  * self[15] * self[12] - 
             self[7]  * self[10]  * self[16] + 
             self[7]  * self[14]  * self[12] +
             self[8] * self[10]  * self[15] - 
             self[8] * self[14]  * self[11];

    res[2] = -self[2]  * self[11] * self[16] + 
              self[2]  * self[15] * self[12] + 
              self[3]  * self[10]  * self[16] - 
              self[3]  * self[14]  * self[12] - 
              self[4] * self[10]  * self[15] + 
              self[4] * self[14]  * self[11];

    res[3] = self[2]  * self[7] * self[16] - 
             self[2]  * self[15] * self[8] - 
             self[3]  * self[6] * self[16] + 
             self[3]  * self[14] * self[8] + 
             self[4] * self[6] * self[15] - 
             self[4] * self[14] * self[7];

    res[4] = -self[2]  * self[7] * self[12] + 
               self[2]  * self[11] * self[8] +
               self[3]  * self[6] * self[12] - 
               self[3]  * self[10] * self[8] - 
               self[4] * self[6] * self[11] + 
               self[4] * self[10] * self[7];

    res[5] = -self[5]  * self[11] * self[16] + 
              self[5]  * self[15] * self[12] + 
              self[7]  * self[9] * self[16] - 
              self[7]  * self[13] * self[12] - 
              self[8] * self[9] * self[15] + 
              self[8] * self[13] * self[11];

    res[6] = self[1]  * self[11] * self[16] - 
             self[1]  * self[15] * self[12] - 
             self[3]  * self[9] * self[16] + 
             self[3]  * self[13] * self[12] + 
             self[4] * self[9] * self[15] - 
             self[4] * self[13] * self[11];

    res[7] = -self[1]  * self[7] * self[16] + 
              self[1]  * self[15] * self[8] + 
              self[3]  * self[5] * self[16] - 
              self[3]  * self[13] * self[8] - 
              self[4] * self[5] * self[15] + 
              self[4] * self[13] * self[7];

    res[8] = self[1]  * self[7] * self[12] - 
              self[1]  * self[11] * self[8] - 
              self[3]  * self[5] * self[12] + 
              self[3]  * self[9] * self[8] + 
              self[4] * self[5] * self[11] - 
              self[4] * self[9] * self[7];

    res[9] = self[5]  * self[10] * self[16] - 
             self[5]  * self[14] * self[12] - 
             self[6]  * self[9] * self[16] + 
             self[6]  * self[13] * self[12] + 
             self[8] * self[9] * self[14] - 
             self[8] * self[13] * self[10];

    res[10] = -self[1]  * self[10] * self[16] + 
              self[1]  * self[14] * self[12] + 
              self[2]  * self[9] * self[16] - 
              self[2]  * self[13] * self[12] - 
              self[4] * self[9] * self[14] + 
              self[4] * self[13] * self[10];

    res[11] = self[1]  * self[6] * self[16] - 
              self[1]  * self[14] * self[8] - 
              self[2]  * self[5] * self[16] + 
              self[2]  * self[13] * self[8] + 
              self[4] * self[5] * self[14] - 
              self[4] * self[13] * self[6];

    res[12] = -self[1]  * self[6] * self[12] + 
               self[1]  * self[10] * self[8] + 
               self[2]  * self[5] * self[12] - 
               self[2]  * self[9] * self[8] - 
               self[4] * self[5] * self[10] + 
               self[4] * self[9] * self[6];

    res[13] = -self[5] * self[10] * self[15] + 
              self[5] * self[14] * self[11] + 
              self[6] * self[9] * self[15] - 
              self[6] * self[13] * self[11] - 
              self[7] * self[9] * self[14] + 
              self[7] * self[13] * self[10];

    res[14] = self[1] * self[10] * self[15] - 
             self[1] * self[14] * self[11] - 
             self[2] * self[9] * self[15] + 
             self[2] * self[13] * self[11] + 
             self[3] * self[9] * self[14] - 
             self[3] * self[13] * self[10];

    res[15] = -self[1] * self[6] * self[15] + 
               self[1] * self[14] * self[7] + 
               self[2] * self[5] * self[15] - 
               self[2] * self[13] * self[7] - 
               self[3] * self[5] * self[14] + 
               self[3] * self[13] * self[6];

    res[16] = self[1] * self[6] * self[11] - 
              self[1] * self[10] * self[7] - 
              self[2] * self[5] * self[11] + 
              self[2] * self[9] * self[7] + 
              self[3] * self[5] * self[10] - 
              self[3] * self[9] * self[6];

    local det = self[1] * res[1] + self[5] * res[2] + self[9] * res[3] + self[13] * res[4];
    assert(det ~= 0, "matrix has no determinant")
